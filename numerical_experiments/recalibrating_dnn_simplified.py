...
from epftoolbox.models import evaluate_once_dnn_in_test_dataset
import os
...
path_recalibration_folder = os.path.join('.', 'experimental_files_d3')
path_hyperparameter_folder = os.path.join('.', 'experimental_files_d3')

#Indicate if the hyperopt was applied in DFL context
DFL=True

#Number of days
days=1

evaluate_once_dnn_in_test_dataset(experiment_id, path_hyperparameter_folder=path_hyperparameter_folder, days=days,
                               path_datasets_folder=path_datasets_folder, shuffle_train=shuffle_train, 
                               path_recalibration_folder=path_recalibration_folder, DFL=DFL,
